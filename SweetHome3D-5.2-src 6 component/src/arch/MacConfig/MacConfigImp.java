...
class MacConfigImp implements IMacOSXConfigurationImp
{
  private static boolean fullScreen;
  /**
   * Enables default menu bar actions if no window is at screen.
   */
  private static void enableDefaultActions(SweetHome3DMainImp homeApplication, HomePane defaultHomeView) {
   ...
   */
  private static JFrame createDummyFrameWithDefaultMenuBar(final SweetHome3DMainImp homeApplication,
  ...
  private static void addWindowMenu(final JFrame frame, 
    ...
    windowMenu.add(new JMenuItem(
        new ResourceAction(preferences, MacConfigImp.class, "ZOOM", !defaultFrame) {
            @Override
            public void actionPerformed(ActionEvent ev) {
    ...
    windowMenu.add(new JMenuItem(
        new ResourceAction(preferences, MacConfigImp.class, "BRING_ALL_TO_FRONT", !defaultFrame) {
            @Override
            public void actionPerformed(ActionEvent ev) {
